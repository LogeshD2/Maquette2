                    ...
                    <div className="flex items-center w-[343px] h-[110px] p-6 rounded shadow-lg md:w-[391px] md:p-4 lg:w-[570px] lg:h-[160px] lg:p-10   ">
                        ...
                        <div className="flex items-center w-[343px] h-[110px] p-6 rounded shadow-lg md:w-[391px] md:p-4 lg:w-[570px] lg:h-[160px] lg:p-10   ">
                            ...
                            <div className="space-x-4">
                                ...
                                <div>  
                                    <p className="text-h7 text-gray block hidden lg:block ml-[25px]"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra nunc ante velit vitae. 
                                        Est tellus vitae, nullam lobortis enim. Faucibus amet etiam tincidunt rhoncus, ullamcorper velit. Lorem ipsum dolor sit amet, consectetur adipiscing elit
                                    </p>
                                </div>
